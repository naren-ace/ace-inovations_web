...
export const BrandWordmark = ({ size = 'md', theme = 'dark', className = '' }) => {
  ...
  return (
    <div className={`flex items-baseline ${className}`}>
      <span
        ...
        style={{ color: aceColor, fontFamily: "'Space Grotesk', sans-serif" }}
      >
        ACE
      </span>
      ...
      <span
        className={`${s.text} font-extralight tracking-tight`}
        style={{ color: novColor, fontFamily: "'Space Grotesk', sans-serif" }}
      >
        novations
      </span>
    </div>
