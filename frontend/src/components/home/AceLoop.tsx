...
export const AceLoop = () => {
  ...
  return (
    <section id="process" ref={ref} className="relative py-24 lg:py-32" data-testid="process-section">
      <div className="section-container relative z-10">
        ...
        <div className="relative">
          ...
          <div className="grid lg:grid-cols-3 gap-12 lg:gap-8">
            {steps.map((step, i) => (
              <motion.div key={step.number} custom={3 + i} variants={fadeUp} initial="hidden" animate={isInView ? 'visible' : 'hidden'}
                className="relative flex flex-col items-center text-center" data-testid={`process-step-${step.number}`}>
                <div className="relative z-10 mb-8">
                  <div className="w-[104px] h-[104px] rounded-full flex flex-col items-center justify-center border"
                    style={{
