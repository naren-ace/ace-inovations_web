    ...
    <section className="py-24 px-6" data-testid="services-section">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <p className="text-sm font-semibold text-ace-blue tracking-widest uppercase mb-3">What We Build</p>
          <h2 className="text-3xl sm:text-4xl font-heading font-bold text-ace-slate">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((service) => (
            ...
            >
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-ace-blue/10 to-ace-violet/10 flex items-center justify-center text-ace-blue mb-4 group-hover:from-ace-blue/20 group-hover:to-ace-violet/20 transition-colors duration-300">
                {service.icon}
              </div>
              <h3 className="font-heading font-semibold text-ace-slate mb-2">{service.title}</h3>
