...
import { LabsPhysics } from '@/components/effects/LabsPhysics'
import { BentoGrid } from '@/components/labs/BentoGrid'
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center min-h-[calc(100vh-4rem)]">
            <div className="flex flex-col justify-center py-16 lg:py-0">
              ...
              <motion.h1 custom={1} variants={fadeUp} initial="hidden" animate={isInView ? 'visible' : 'hidden'}
                ...
                ACE Labs: <span className="gradient-text">The Powerhouse</span>.
              </motion.h1>
              <motion.p custom={2} variants={fadeUp} initial="hidden" animate={isInView ? 'visible' : 'hidden'}
                ...
                Five proprietary systems engineered to eliminate every class of friction between your vision and production-grade reality.
              </motion.p>
              <motion.div custom={3} variants={fadeUp} initial="hidden" animate={isInView ? 'visible' : 'hidden'} className="mt-10">
                <Button variant="labs-indigo" size="lg" onClick={() => setContactOpen(true)} className="btn-glow-indigo" data-testid="labs-explore-btn">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="space-y-6">
              ...
              <motion.div custom={4} variants={fadeUp} initial="hidden" animate={isInView ? 'visible' : 'hidden'}>
                <Button variant="labs-indigo" size="lg" onClick={() => setContactOpen(true)} className="btn-glow-indigo" data-testid="labs-philosophy-cta">
