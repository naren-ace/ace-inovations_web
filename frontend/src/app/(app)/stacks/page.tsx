          ...
          <div className="section-container relative z-10">
            <div className="max-w-3xl">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-[1.08] tracking-tighter text-foreground" data-testid="stacks-hero-heading">
                Insights:{' '}<span className="gradient-text">Field Notes from the Frontline</span>.
              </h1>
              ...
              <div className="lg:col-span-2">
                {posts.length === 0 ? (
                  <div className="text-center py-20" data-testid="stacks-empty">
                    <p className="text-lg" style={{ color: 'hsl(var(--caption))' }}>No published insights yet.</p>
                    <p className="text-sm mt-2" style={{ color: 'hsl(var(--caption))' }}>Create your first insight in the <Link href="/ace-control-center" className="text-primary hover:underline">Control Center</Link>.</p>
                  </div>
                ) : (
